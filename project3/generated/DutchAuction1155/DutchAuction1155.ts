...
export class DutchAuction1155__getCurrentStepDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class DutchAuction1155 extends ethereum.SmartContract {
  ...
  getCurrentStepData(): DutchAuction1155__getCurrentStepDataResult {
    let result = super.call(
      "getCurrentStepData",
    ...
    return new DutchAuction1155__getCurrentStepDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getCurrentStepData(): ethereum.CallResult<DutchAuction1155__getCurrentStepDataResult> {
    let result = super.tryCall(
      "getCurrentStepData",
      "getCurrentStepData():(uint256,uint256,uint256)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new DutchAuction1155__getCurrentStepDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),

...
export class SealedBidAuctionV1721__getAuctionInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SealedBidAuctionV1721__getBidDepositAddrResult {
  value0: Bytes;
  value1: Address;
...
export class SealedBidAuctionV1721__getNFTInfoResult {
...
export class SealedBidAuctionV1721__revealInput_headerStruct extends ethereum.Tuple {
  get hash(): Bytes {
...
export class SealedBidAuctionV1721__revealInput_accountDataProofStruct extends ethereum.Tuple {
...
export class SealedBidAuctionV1721 extends ethereum.SmartContract {
  static bind(address: Address): SealedBidAuctionV1721 {
    return new SealedBidAuctionV1721("SealedBidAuctionV1721", address);
  }
  ...
  getAuctionInfo(): SealedBidAuctionV1721__getAuctionInfoResult {
    let result = super.call(
      "getAuctionInfo",
    ...
    return new SealedBidAuctionV1721__getAuctionInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAuctionInfo(): ethereum.CallResult<SealedBidAuctionV1721__getAuctionInfoResult> {
    let result = super.tryCall(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,uint256,uint256,uint256,uint256,address,uint256,bool)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1721__getAuctionInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): SealedBidAuctionV1721__getBidDepositAddrResult {
    let result = super.call(
      "getBidDepositAddr",
    ...
    return new SealedBidAuctionV1721__getBidDepositAddrResult(
      result[0].toBytes(),
      result[1].toAddress(),
    );
  }
  ...
  try_getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): ethereum.CallResult<SealedBidAuctionV1721__getBidDepositAddrResult> {
    let result = super.tryCall(
      "getBidDepositAddr",
      "getBidDepositAddr(address,uint256,bytes32):(bytes32,address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1721__getBidDepositAddrResult(
        value[0].toBytes(),
        value[1].toAddress(),
      ),
    );
  ...
  getNFTInfo(): SealedBidAuctionV1721__getNFTInfoResult {
    let result = super.call(
      "getNFTInfo",
    ...
    return new SealedBidAuctionV1721__getNFTInfoResult(
      result[0].toAddressArray(),
      result[1].toBigIntArray(),
    );
  }

  try_getNFTInfo(): ethereum.CallResult<SealedBidAuctionV1721__getNFTInfoResult> {
    let result = super.tryCall(
      "getNFTInfo",
      "getNFTInfo():(address[],uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1721__getNFTInfoResult(
  ...
  reveal(
    ...
    _header: SealedBidAuctionV1721__revealInput_headerStruct,
    _accountDataProof: SealedBidAuctionV1721__revealInput_accountDataProofStruct,
  ): Address {
    let result = super.call(
      "reveal",

...
export class SealedBidAuctionV21155__getAuctionInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SealedBidAuctionV21155__getNFTInfoResult {
...
export class SealedBidAuctionV21155 extends ethereum.SmartContract {
  static bind(address: Address): SealedBidAuctionV21155 {
    return new SealedBidAuctionV21155("SealedBidAuctionV21155", address);
  }
  ...
  getAuctionInfo(): SealedBidAuctionV21155__getAuctionInfoResult {
    let result = super.call(
      "getAuctionInfo",
    ...
    return new SealedBidAuctionV21155__getAuctionInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAuctionInfo(): ethereum.CallResult<SealedBidAuctionV21155__getAuctionInfoResult> {
    let result = super.tryCall(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,uint256,uint256,uint256,address,uint256,uint256,uint256,address,bool)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV21155__getAuctionInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getNFTInfo(): SealedBidAuctionV21155__getNFTInfoResult {
    let result = super.call(
      "getNFTInfo",
    ...
    return new SealedBidAuctionV21155__getNFTInfoResult(
  ...
  try_getNFTInfo(): ethereum.CallResult<SealedBidAuctionV21155__getNFTInfoResult> {
    let result = super.tryCall(
      "getNFTInfo",
      "getNFTInfo():(address[],uint256[],uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV21155__getNFTInfoResult(

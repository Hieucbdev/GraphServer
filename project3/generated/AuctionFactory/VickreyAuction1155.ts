...
export class VickreyAuction1155__getAuctionInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VickreyAuction1155__getBidDepositAddrResult {
  value0: Bytes;
  value1: Address;
...
export class VickreyAuction1155__getNFTInfoResult {
...
export class VickreyAuction1155__revealInput_headerStruct extends ethereum.Tuple {
  get hash(): Bytes {
...
export class VickreyAuction1155__revealInput_accountDataProofStruct extends ethereum.Tuple {
...
export class VickreyAuction1155 extends ethereum.SmartContract {
  static bind(address: Address): VickreyAuction1155 {
    return new VickreyAuction1155("VickreyAuction1155", address);
  }
  ...
  getAuctionInfo(): VickreyAuction1155__getAuctionInfoResult {
    let result = super.call(
      "getAuctionInfo",
    ...
    return new VickreyAuction1155__getAuctionInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAuctionInfo(): ethereum.CallResult<VickreyAuction1155__getAuctionInfoResult> {
    let result = super.tryCall(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,uint256,uint256,uint256,uint256,address,uint256,uint256,bool)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new VickreyAuction1155__getAuctionInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): VickreyAuction1155__getBidDepositAddrResult {
    let result = super.call(
      "getBidDepositAddr",
    ...
    return new VickreyAuction1155__getBidDepositAddrResult(
      result[0].toBytes(),
      result[1].toAddress(),
    );
  }
  ...
  try_getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): ethereum.CallResult<VickreyAuction1155__getBidDepositAddrResult> {
    let result = super.tryCall(
      "getBidDepositAddr",
      "getBidDepositAddr(address,uint256,bytes32):(bytes32,address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VickreyAuction1155__getBidDepositAddrResult(
        value[0].toBytes(),
        value[1].toAddress(),
      ),
    );
  ...
  getNFTInfo(): VickreyAuction1155__getNFTInfoResult {
    ...
    return new VickreyAuction1155__getNFTInfoResult(
  ...
  try_getNFTInfo(): ethereum.CallResult<VickreyAuction1155__getNFTInfoResult> {
    let result = super.tryCall(
      "getNFTInfo",
      "getNFTInfo():(address[],uint256[],uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new VickreyAuction1155__getNFTInfoResult(
  ...
  reveal(
    ...
    _header: VickreyAuction1155__revealInput_headerStruct,
    _accountDataProof: VickreyAuction1155__revealInput_accountDataProofStruct,
  ): Address {
    let result = super.call(
      "reveal",

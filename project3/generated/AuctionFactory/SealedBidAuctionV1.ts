...
export class SealedBidAuctionV1__getAuctionInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SealedBidAuctionV1__getBidDepositAddrResult {
  value0: Bytes;
  value1: Address;
...
export class SealedBidAuctionV1__getNFTInfoResult {
...
export class SealedBidAuctionV1__revealInput_headerStruct extends ethereum.Tuple {
  get hash(): Bytes {
...
export class SealedBidAuctionV1__revealInput_accountDataProofStruct extends ethereum.Tuple {
...
export class SealedBidAuctionV1 extends ethereum.SmartContract {
  static bind(address: Address): SealedBidAuctionV1 {
    return new SealedBidAuctionV1("SealedBidAuctionV1", address);
  }
  ...
  getAuctionInfo(): SealedBidAuctionV1__getAuctionInfoResult {
    let result = super.call(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,uint256,uint256,uint256,uint256,address,uint256)",
      [],
    );

    return new SealedBidAuctionV1__getAuctionInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getAuctionInfo(): ethereum.CallResult<SealedBidAuctionV1__getAuctionInfoResult> {
    let result = super.tryCall(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,uint256,uint256,uint256,uint256,address,uint256)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1__getAuctionInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): SealedBidAuctionV1__getBidDepositAddrResult {
    let result = super.call(
      "getBidDepositAddr",
    ...
    return new SealedBidAuctionV1__getBidDepositAddrResult(
      result[0].toBytes(),
      result[1].toAddress(),
    );
  }
  ...
  try_getBidDepositAddr(
    ...
    _bid: BigInt,
    _subSalt: Bytes,
  ): ethereum.CallResult<SealedBidAuctionV1__getBidDepositAddrResult> {
    let result = super.tryCall(
      "getBidDepositAddr",
      "getBidDepositAddr(address,uint256,bytes32):(bytes32,address)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1__getBidDepositAddrResult(
        value[0].toBytes(),
        value[1].toAddress(),
      ),
    );
  ...
  getNFTInfo(): SealedBidAuctionV1__getNFTInfoResult {
    let result = super.call(
      "getNFTInfo",
    ...
    return new SealedBidAuctionV1__getNFTInfoResult(
  ...
  try_getNFTInfo(): ethereum.CallResult<SealedBidAuctionV1__getNFTInfoResult> {
    let result = super.tryCall(
      "getNFTInfo",
      "getNFTInfo():(address[],uint256[],uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SealedBidAuctionV1__getNFTInfoResult(
  ...
  reveal(
    ...
    _header: SealedBidAuctionV1__revealInput_headerStruct,
    _accountDataProof: SealedBidAuctionV1__revealInput_accountDataProofStruct,
  ): Address {
    let result = super.call(
      "reveal",

...
export class EnglishAuction__getAuctionInfoResult {
  value0: Address;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class EnglishAuction__getNFTInfoResult {
...
export class EnglishAuction extends ethereum.SmartContract {
  static bind(address: Address): EnglishAuction {
    return new EnglishAuction("EnglishAuction", address);
  }
  ...
  getAuctionInfo(): EnglishAuction__getAuctionInfoResult {
    let result = super.call(
      "getAuctionInfo",
    ...
    return new EnglishAuction__getAuctionInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_getAuctionInfo(): ethereum.CallResult<EnglishAuction__getAuctionInfoResult> {
    let result = super.tryCall(
      "getAuctionInfo",
      "getAuctionInfo():(address,uint256,address,uint256,uint256,uint256,uint256,address)",
      [],
    ...
    return ethereum.CallResult.fromValue(
      new EnglishAuction__getAuctionInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  getNFTInfo(): EnglishAuction__getNFTInfoResult {
    let result = super.call(
      "getNFTInfo",
    ...
    return new EnglishAuction__getNFTInfoResult(
  ...
  try_getNFTInfo(): ethereum.CallResult<EnglishAuction__getNFTInfoResult> {
    let result = super.tryCall(
      "getNFTInfo",
      "getNFTInfo():(address[],uint256[],uint256[])",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EnglishAuction__getNFTInfoResult(
